        ...
        <div class="row">
            <div class="col-md-4">
                <div class="row">
                    ...
                    <div class="col-xs-11">
                        <button class="btn btn-warning" style="width:200px;" onclick="window.location.href='/projects'">Share Your Story</button>
                    </div>
                </div>
                <br>
            ...
            <div class="col-md-4">
                <div class="row">
                    ...
                    <div class="col-xs-11">
                        <button class="btn btn-warning" style="width:200px;">Explore All Stories</button>
                    </div>
                </div>
                <br>
