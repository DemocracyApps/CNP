...
<ul>
  ...
  <br>
  <h4>The CNP is intended to help communities learn about themselves, tell about themselves, and decide about their futures. Applications include:</h4>
  <ul>
      <li>Community Self-Discovery</li>
      <li>Community Planning</li>
      <li>Community Engagement</li>    
      <li>Journalism - Reporting and Reader Engagement</li>
      <li>Journalism - Information Gathering</li>
      <li>Surveys</li>
      <li>Crowd-Sourced Problem-Solving</li>
  </ul>
</div>
